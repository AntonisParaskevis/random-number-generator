...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
          /* The program can generate up to 1001 unique random numbers at a time (0-1000). Trying to generate more than that would lead to an infinite loop.
             Therefore, we check if the random numbers that the user wants to generate are more than 1001, 1001, or less than 1001.
             If they're more than 1001, display a message notifying the user about that.
             Otherwise, generate the numbers */
            if (numericUpDown1.Value > 1001)
            {
                MessageBox.Show("Only up to 1001 unique random numbers can be generated at a time.", "The numbers were not generated");
            }
            else 
            {
